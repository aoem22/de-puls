...
export async function GET(request: NextRequest) {
  ...
  // Validate: must start with chunks/raw/, no traversal
  if (!filePath.startsWith('chunks/raw/') || filePath.includes('..')) {
  ...
  // Flat filename is already descriptive: chunks/raw/hessen_januar_2024.json
